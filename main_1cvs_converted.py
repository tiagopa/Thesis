...
if __name__ == '__main__':
	...
	with open('test5.csv', mode='r') as csv_file1:
		...
		for row in csv_reader1:
			...
			### NOT FIRST TIME (MAIN)
				...
				# 		# if coord_dist(actual_position,estimate_coord(last_valid,vx,vy,vz,sample_time*missed_samples)) > 5:
				# 		# 	vector1.append(actual_position)
				# 		# 	actual_position = estimate_coord(last_valid,vx,vy,vz,sample_time*missed_samples)
				# 		# 	if next_info.coordinates == [38.737893, -9.139069]:
				# 		# 		print(last_valid)
				# 		# 		print(str(m.degrees(orientation__(vx,vy)))+str(orientation) )
				...
				if velocity < 23 or point_out_of_polygon == True:
					...
					if (next_info and next_info.previous_node is not None and next_info.info_type != 'intersection' and next_info.previous_node.info_type != 'intersection') or point_out_of_polygon == True:
						...
						if distance_travelled > 2*distance or point_out_of_polygon == True or dist_to_next > 100:
				...
				if (next_info and next_info.info_type == 'intersection' and orientation != next_info.previous_node.orientation and dist_to_next < next_info.radius) or end_of_street_normal == True:
					...
					# print('INTERSECTIONNNNNNNNNNNNNN')
